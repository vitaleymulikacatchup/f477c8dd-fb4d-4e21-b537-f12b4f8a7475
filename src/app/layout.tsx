...
export const metadata: Metadata = {
  title: "Garant - Premium Swedish Snus | Authentic Tobacco Products",
  description: "Experience premium Swedish-style snus from Garant. Crafted with traditional methods using finest tobacco. Quality guaranteed, authentic taste.",
  keywords: "premium snus, Swedish snus, tobacco products, authentic snus, quality snus, traditional tobacco",
  metadataBase: new URL("https://garant-snus.com"),
  alternates: {
    canonical: "https://garant-snus.com"
  },
  openGraph: {
    title: "Garant - Premium Swedish Snus",
    description: "Experience premium Swedish-style snus crafted with traditional methods and finest tobacco.",
    siteName: "Garant",
    images: [{
      url: "https://images.pexels.com/photos/10191850/pexels-photo-10191850.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Premium Garant snus products"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Garant - Premium Swedish Snus",
    description: "Experience premium Swedish-style snus crafted with traditional methods.",
    images: ["https://images.pexels.com/photos/10191850/pexels-photo-10191850.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  }
};
